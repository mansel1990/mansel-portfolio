...
const experiences = [
  {
    ...
    highlights: [
      "Managing team of 10 employees with technical guidance",
      "Overseeing Swap Logistics and Insurance platform projects",
      "Directing task assignments for project stability",
    ],
  },
  {
    ...
    location: "Mashreq Bank",
    current: false,
    color: "cyan",
    achievement: "Banking",
    highlights: [
      "Developed core loan payment features using React",
  ...
  },
  {
    ...
    highlights: [
      "$1M annual cost savings through optimization",
      "Led ExtJS to React modernization POC",
    ],
  },
  {
    company: "Walking Tree Consultancy",
    position: "Senior Software Engineer",
    ...
    highlights: [
      "Architected UI upgrade for risk management engine",
      "Built custom ExtJS components with Sencha Touch",
      "Enforced coding standards through systematic code reviews",
    ],
  },
  {
    ...
    color: "cyan",
    teamSize: "6",
    achievement: "Zero Bugs",
    highlights: [
      "Achieved first-time bug-free releases through rigorous testing",
      "Modernized platform from HTML to ExtJS framework",
      "Developed reusable PL/SQL functions across projects",
    ],
  },
];
